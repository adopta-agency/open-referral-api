...
$app->get($route, function ()  use ($app){
	...
	//open admin file
	$content = '<?php' . chr(13);
	$admin_file = $_SERVER['DOCUMENT_ROOT'] . "methods/admin.php";
	...
	// open public file
	$content = '<?php' . chr(13);
	$public_file = $_SERVER['DOCUMENT_ROOT'] . "methods/public.php";
	$fp = fopen($public_file, "w");
	fwrite($fp, $content);
	fclose($fp);
				...
				foreach($Swagger_Paths as $key => $value)
					...
					foreach($value as $key2 => $value2)
			        	...
			        	$Method .= "?>" . chr(13);
			  			...
			  			$AccountFolder = $_SERVER['DOCUMENT_ROOT'] . "methods/";
						...
						array_push($ReturnObject,$Path_Route);
						
						// write admin
						$content = 'require_once ' . chr(39) . $PHP_File_Name . chr(39) . chr(59) . chr(13);
						$admin_file = $_SERVER['DOCUMENT_ROOT'] . "methods/admin.php";
						echo $admin_file . "<br />";
